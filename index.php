...
<div class="galerry">
    <?php
    $ambil_galeri = mysqli_query($koneksi, "SELECT * FROM galeri ORDER BY gambar_id DESC LIMIT 3");

    while ($gal = mysqli_fetch_assoc($ambil_galeri)) {
    ?>
        <img src="Aset/<?= htmlspecialchars($gal['nama_gambar']); ?>" alt="Foto Galeri">
    <?php
    }
    ?>
</div>
